...
--
-- 실행 role: domainrag_platform_admin (BYPASSRLS). RLS 영향 없음 — domain_id가 명시.
-- 검증: SELECT email, clearance, department FROM user_tenant_membership
--       WHERE domain_id='exam-engineer' AND is_active=true;
-- ============================================================================
...
INSERT INTO user_tenant_membership (
    user_id, domain_id, clearance, department, domain_groups,
...
--    WHERE domain_id = 'exam-engineer' AND email = '<email>';
