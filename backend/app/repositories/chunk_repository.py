...
(domain_id, doc_id, doc_version, parser_version) 키 단위로 DELETE+INSERT를 한 트랜잭션에
...
class PostgresChunkRepository:
    ...
    replace_chunks: 같은 (domain_id, doc_id, doc_version, parser_version) 묶음의 기존
    ...
    async def delete_by_doc(
        ...
        *,
        ...
        params: dict[str, Any] = {"domain_id": domain_id, "doc_id": doc_id}
        version_clause = ""
