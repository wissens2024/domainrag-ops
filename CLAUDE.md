...
| [ADR-029](docs/adr/029-assessment-item-evaluation.md) | **Assessment Item Evaluation** (사전 추론 평가 — 1단계: 예상 난이도 상/중/하 LLM 독립 추정+내용검증. 변별도는 모의 응시자 시뮬레이션으로 후속) | Accepted (ADR-014/027 확장) |
